    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new byte[] { 226, 220, 4, 141, 154, 150, 93, 67, 187, 164, 223, 63, 50, 89, 131, 220 }, "b08a59c9-d3bc-48d3-8493-35a509fc0a83", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new byte[] { 79, 113, 189, 105, 118, 149, 186, 69, 181, 183, 240, 6, 73, 190, 0, 222 }, 0, "b153ad7e-d01e-472a-8b86-811849e54e90", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "tedu.international@gmail.com", true, "Toan", "Bach", false, null, "tedu.international@gmail.com", "admin", "AQAAAAEAACcQAAAAEKQcixu6EtFlRP5o0nxrJtMNbKOnVKMsV3BgGuFgV836s5eyJzy+/pxa8slmiD/UWw==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 10, 7, 0, 28, 15, 972, DateTimeKind.Local).AddTicks(2756), null, 100000m, 200000m });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "AppRoles",
                keyColumn: "Id",
                keyValue: new byte[] { 226, 220, 4, 141, 154, 150, 93, 67, 187, 164, 223, 63, 50, 89, 131, 220 });

            migrationBuilder.DeleteData(
                table: "AppUsers",
                keyColumn: "Id",
                keyValue: new byte[] { 79, 113, 189, 105, 118, 149, 186, 69, 181, 183, 240, 6, 73, 190, 0, 222 });
